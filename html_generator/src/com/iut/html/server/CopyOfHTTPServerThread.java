 ...
 *
 */
public class CopyOfHTTPServerThread extends Thread {
	 ...
	 * @param socket
	 */
	public CopyOfHTTPServerThread(Socket socket) {
		super();
	...
	public void run() {
		try {
			...
			try {
				...
				this.clientSocket.getOutputStream().write(CopyOfHTTPServerThread.ERROR_MESSAGE.getBytes());
